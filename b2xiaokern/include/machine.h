...
#  define ETH_MAC_TXEN 0x8
#  define ETH_MAC_RXEN 0x4
# define ETH_MAC_MII_ACC 6
#  define ETH_MII_BCR 0
#   define ETH_MII_BCR_RESET 0x8000
#   define ETH_MII_BCR_ANENABLE 0x1000
#   define ETH_MII_BCR_ANRESTART 0x200
#  define ETH_MII_BSR 1
#   define ETH_MII_BSR_LSTS 0x4
#  define ETH_MII_ADVERTISE 4
# define ETH_MAC_MII_DATA 7
#  define ETH_MII_ACC_BUSY 1
#  define ETH_MII_ACC_WRITE 2
#  define ETH_MII_ACC_PHY 0x800
