...
#define poll_add(chan, flags) sys_poll_add(chan, flags)
#define poll_remove(chan, flags) sys_poll_remove(chan, flags)
#define poll_wait(result) sys_poll_wait(result)
